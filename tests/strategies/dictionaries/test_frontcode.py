...
def test_roundtrip_basic() -> None:
    ...
    assert frontcode._decode(frontcode._encode(mapping)) == mapping


def test_roundtrip_empty() -> None:
    assert frontcode._decode(frontcode._encode({})) == {}
...
def test_roundtrip_reverse_key() -> None:
    ...
    assert frontcode._decode(frontcode._encode(mapping, reverse_key=True)) == mapping
