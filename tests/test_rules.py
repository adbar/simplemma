...
def test_apply_de():
    ...
    # assert apply_de("Schneidern") == "Schneider"
    ...
    assert apply_de("Chauffeusen") == "Chauffeuse"
    assert apply_de("Bibliotheken") == "Bibliothek"
    assert apply_de("Kazakhstans") == "Kazakhstan"
    assert apply_de("Gymnasiasten") == "Gymnasiast"
    assert apply_de("Dezernates") == "Dezernat"
    assert apply_de("Luftikussen") == "Luftikus"
    assert apply_de("Trunkenbolde") == "Trunkenbold"
    assert apply_de("Theologien") == "Theologie"
    assert apply_de("Geschädigten") == "Geschädigte"
    ...
    assert apply_de("viszerale") == "viszeral"
    assert apply_de("kurioses") == "kurios"
    assert apply_de("adipösen") == "adipös"
    assert apply_de("isotropen") == "isotrop"
    assert apply_de("kulanten") == "kulant"
    assert apply_de("konvexes") == "konvex"
    assert apply_de("myope") == "myop"
    assert apply_de("kompetenteste") == "kompetent"
    assert apply_de("leiwandste") == "leiwand"
    assert apply_de("luzidesten") == "luzide"  # luzid?
    assert apply_de("frigides") == "frigide"
    assert apply_de("frigideren") == "frigide"
    assert apply_de("kruden") == "krude"
    assert apply_de("krudesten") == "krude"
